...
//#define LPC_PHY_DP83848	/* Enable this define to use the DP83848 PHY driver. */
...
/**
 * Set this define to '0' to use traditional copied buffers. If set
...
/**
 * Defines the number of descriptors used for RX. A higher number of
...
/**
 * Set this define to '1' to enable zero-copy pbufs for transmit.
...
/**
 * Defines the number of descriptors used for TX. In zero-copy mode,
...
/**
 * Set this define to 1 to enable bounce buffers for transmit pbufs
